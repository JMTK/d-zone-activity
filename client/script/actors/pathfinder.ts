...
export default {
    ...
    findPath: function (options : any) {
        ...
        var openCount = 0, open : any = {}, closed : any = {};
...
var constructPath = function (start : any, current : any, closed : any) {
    var path : { x: number, y: number, z: number }[] = []; var cur = current;
    while (true) {
