...
var charSets = {
    ...
    lower: {
        y: 8, height: 11, xSpacing: 1, chars: [
    ...
    numsAndSymbols: {
        y: 19, xSpacing: 1, height: 8, chars: [
    ...
    icons: {
        count: 4, y: 27, height: 12, chars: [
            [':icon-npm:', 12], [':icon-github:', 12], [':icon-lock:', 12], [':icon-lock-small:', 12]
        ]
    },
    accented1: {
        y: 39, xSpacing: 1, height: 13, oy: -2, chars: [
    ...
    accented2: {
        y: 52, xSpacing: 1, height: 10, oy: -2, chars: [
